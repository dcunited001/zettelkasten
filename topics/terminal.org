...
screen -t "1: journalctl: GnuPG and pcscd"
exec !journalctl -f --no-tail --no-pager -b -p7 -u --user gpg-agent
exec !journalctl -f --no-tail --no-pager -b -p7 -u --user yubikey-touch-detector
exec !journalctl -f --no-tail --no-pager -b -p7 -u pcscd
split
focus down
# title "2: bash"
screen -t "2: bash"
