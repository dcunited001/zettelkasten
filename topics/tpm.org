...
** PCR
+ [[https://github.com/openconfig/security-services][openconfig/security-services]] contains =.proto= for PCR data
* Resources
...
*** TPM Key Hierarchy
From [[https://ericchiang.github.io/post/tpm-keys/][Trusted Platform Key Hierarchy]]

[[file:img/tpm-hierarchy.png]]
