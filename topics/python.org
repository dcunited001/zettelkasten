...
**** Using Colab's Runtime =.json= File

[[https://github.com/emacs-jupyter/jupyter/issues/231][emacs-jupyter/jupyter#231]] in which someone pops the question... and there's an
answer? holy shit. WILSON! YOU'LL NEVER BELIEVE THIS! WILSON!

#+begin_quote
And I immediately got banned from Google Colab -- thanks a lot Gemini. BOTH
ACCOUNTS!! WTF?! I had no idea. I ran:

=from colab_ssh import launch_ssh, launch_device_ssh=

and I was sitting there thinking about how it was dumb, but how to get it to
accept a key (and whether I needed a jump proxy)

... bam. Auto-ban-hammer. The message said I could "Appeal", but we'll see.
Clicking it prompted the typical feedback message, but with no further
instructions.

It's just not a good sign if, in the end, no one listens to a person affected by
FAANG systems. It also doesn't mean much, but that's like a litmus i'm watching:
does FAANG/AI wall themselves off and let people become dissociated from their
organizations?

Social media was rampantly shadowbanning people... translation: given the
benefit of the doubt, it was really easy for "customers" to experience being
tossed around by network theoretic effects. Or downranking via censorship &
mobbing ... or who knows?

How does it magically get better?
#+end_quote
