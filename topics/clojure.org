...
** Documentary
+ [[https://www.youtube.com/watch?v=Y24vK_QDLFg][How one programmer's pet project changed how we think about software]]
  - [[https://docs.google.com/spreadsheets/d/1P3z4Nh02l6zIeGypgQ5wKGUe6Lq0lUCR-R35b0MF7mU/edit?gid=1078381722#gid=1078381722][The Papers of Clojure]]: compiled list of research that influenced clojure's
    development
...
+ [[https://github.com/jsa-aerial/hanasu][ariela.hanasu]]
+ [[https://github.com/7theta/via][7theta.via]] (offline)
...
Client (clj/s) + Server (clj), but intended to be symmetric
