...
Getting close to statistical manifolds & information geometry.


**** Tree-Structured Parzen Estimator

Used by MIPROv2 (for prompt optimization), though it it's pretty heavy duty
unless.

[[https://arxiv.org/abs/2304.11127][TPE: Understanding Alg. Components/Roles For Better Empirical Performance]]

+ Tunes hyperparameters as ML network instances explore the hyperplane by
  facilitating iterative KDE density calculation (& estimating a posterior)
  - Then it splits networks according to how they're moving in relation to the
    assumed KDE density.
  - It uses a tree-based search or something idk. Sounds similar to XGBoost
    (though [[https://github.com/cdonnerer/xgboost-distribution][xgboost-distribution]] actually does Max LE, apparently)
