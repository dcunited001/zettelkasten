...
#+begin_src shell :results output file :file img/guix/texlive-schemes.png
guix shell recutils
#texlives="$(guix search 'texlive-scheme-.*' | recsel -CP name)"
texlives=$(echo texlive-scheme-{minimal,basic,medium,full})
guix graph --type=package --max-depth=1 $texlives \
    | dot  -Tsvg -Ktwopi -Granksep=3
#    | dot  -Tsvg -Kcirco -Gnormalize
#    | dot  -Tsvg -Kfdp -Grepulsiveforce=5
#    | dot -Tsvg -Ksfdp -Grepulsiveforce=5
#+end_src

#+RESULTS:
[[file:img/guix/texlive-schemes.png]]

The full schemes

[[file:img/guix/texlive-schemes-full.png]]
