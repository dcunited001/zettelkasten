...
paste -sd" " \
  ...
  <(tree ./guix-deployments/modules --noreport) \
  <(tree ./guix-systole/systole --noreport) \
  <(tree ./mnt-reform-nonguix/.guix/modules --noreport) \
  <(tree ./radix/modules --noreport) \
  <(tree ./rde/src --noreport) \
  <(tree ./rosenthal/modules --noreport) \
  <(tree ./saayix/modules --noreport) \
  <(tree ./sops-guix/modules --noreport) \
#+end_src
