...
** Data Science
+ [[https://github.com/strobus/i-ching][strobus/i-ching]] node.js library
+ [[https://www.researchgate.net/publication/370747951_ICKG_An_I_Ching_Knowledge_Graph_Tool_Revealing_Ancient_Wisdom][I Ching Knowledge Graph (ICKG)]] (source: [[https://github.com/KChen-lab/ICKG][KChen-lab/ICKG]])
+ [[designviz.osu.edu/iching]] data visualization of themes and references running through the
  iching.
...
** Topics
*** The Taixuanjing as [[https://www.tony5m17h.net/][Vedic Clifford Algebra]]
...
* Star Gauge
The [[https://en.wikipedia.org/wiki/Star_Gauge][Star Guage]] is a particularly demented combination of Sudoku, commutator
matrices, Context Free Grammars, binomial coefficients and ... poetry.
