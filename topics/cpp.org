...
** Cheatsheets
 + [[https://www.cheat-sheets.org/saved-copy/STL%20Quick%20Reference%201.29.pdf][STL Quick Reference (2007)]]
 + [[https://habibrahman.me/assets/pdfs/refresh-cpp_stl-v1.0.0.pdf][C++ STL Cheatsheet v1.0.0 (2024)]]
...
** Resources
+ [[https://youtu.be/p_RyYmH-qwY?si=Ydok6wGAfcHvqH-o][Nix - Packaging lib60870 with CMake]] survey of a CMake project
** Topics
...
*** Structure
**** [[https://youtu.be/p_RyYmH-qwY?si=Ydok6wGAfcHvqH-o][Nix - Packaging lib60870 with CMake]]

+ Don't use =file(GLOB...)= (bc build stage idk)
+ recommends [[https://crascit.com/professional-cmake/][Professional CMake]] for templates, guidelines best practices

... There's a [[https://github.com/jonringer/nix-template][nix-template]] command...
* Bazel
...
#+begin_src css
dt { color: #626; font-weight: 600; }
p { margin: 0.3em; text-indent: 2em; }
dd { text-indent: 2em;}
ul { margin: 0.1em; }

h2 { background-color: #BDF; }
h1, h2, h3, h4, h5, h6 { margin: 0.1em; font-weight:bold; }

.pros:before, .pros:after { margin-bottom: inherit; }
.pros { color: #363; }
.pros:before, .pros:after { margin-bottom: inherit; }
.cons { color: #833; }
.cons:before, .cons:after { margin-bottom: inherit; }
.definition { color: #633; }
.definition:before, .definition:after { margin-bottom: inherit; }
.decision { color: #317; }
.decision:before, .decision:after { margin-bottom: inherit; }
.exception { color: #A73; }
.exception:before, .exception:after { margin-bottom: inherit; }
.decision { color: #137; }

pre { font-size: 0.8em;}
pre.goodcode { background-color:  #FFF; }
pre.badcode { background-color:  #FFF; }}
pre.neutralcode { background-color:  #FFF; }

/* .link_button { margin-left: 0px;} */

.toc_category, .toc_stylepoint { padding-top: 1em; padding-bottom: 1em; }
td .toc_category a { color: #333; text-decoration: none; }
td .toc_stylepoint a { color: #333; text-decoration: none; }
#+end_src

#+begin_src javascript
h2 = Array.from(document.querySelectorAll("h2"))
h2.forEach((el) => el.setAttribute("style", ""))
h3 = Array.from(document.querySelectorAll("h3"))
h3.forEach((el) => el.setAttribute("style", ""))
#+end_src
