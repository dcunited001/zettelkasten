...
+ [[https://jhalon.github.io/breaking-into-cyber-security/][So you want to work in cyber security?]] a ton of links
...
*** Low level debuggers
See article: [[https://www.vinnie.work/blog/2021-01-08-low-level-debuggers][Low Level Debuggers]]

  + covers lldb (llvm debugger that speaks gdb protocol)
  + [[https://github.com/pwndbg/pwndbg][pwndbg/pwndbg]] ([[https://pwndbg.re/stable/][docs]], [[https://pwndbg.re/dev/CHEATSHEET.pdf][cheatsheet]])
    - uses [[https://github.com/capstone-engine/capstone][capstone-engine/capstone]] & [[capstone-engine/capstone][unicorn-engine/unicorn]]
  + [[https://github.com/hugsy/gef][hugsy/gef]] ([[https://hugsy.github.io/gef/][docs]])
+ [[https://qiling.io/][Qiling]] binary emulation framework (unicorn). emulates the OS kernel/hardware
  - uses python for automation

*** Triton & Angr

+ Triton DBA (dynamic binary analysis)
+ [[https://angr.io/][Angr.io]]

#+begin_quote
"Triton traces instructions at runtime, translating them into an Intermediate
Representation (IR) and tying them to an SMT solver (like Z3)."

See [[https://triton-library.github.io/][publications]] ... it's probably overkill
#+end_quote
