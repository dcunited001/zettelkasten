...
+Much+ easier(?) to define rules for visual layout... if you don't mind a teensy
bit of Java. (and idk, haven't tried it)

+ [[https://eclipse.dev/elk/documentation/tooldevelopers/graphdatastructure.html][Graph Data Structure]]
  - [[https://eclipse.dev/elk/documentation/tooldevelopers/graphdatastructure/coordinatesystem.html][Coordinate Systems]] hierarchical transforms for graph elements
  - [[https://eclipse.dev/elk/documentation/tooldevelopers/graphdatastructure/elktextformat.html][ELK Text Format]]: the =.dot= equivalent

+ ELK Live [[https://rtsys.informatik.uni-kiel.de/elklive/examples.html?e=ports%2FportConstraints][Example: Port Constraints]]: can define "ports" on nodes

This gives you similar functionality to Draw.io, but you could actually program
to produce diagrams (without worrying about =base64= encoding or whatever)

[[file:img/eclipse-elk.png]]
