...
See: [[https://en.wikipedia.org/wiki/Register_(sociolinguistics)][Register_(sociolinguistics)]]
...
*** Correlatives
A common basis (in western languages) and in science) for many function words and
=-X-ifications= to extend/combine morphemes
