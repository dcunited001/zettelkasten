...
** Firmware
+ [[https://www.linkedin.com/pulse/cracking-open-router-reverse-engineering-tp-link-archer-kumara-alluru-hapke/][Cracking Open a Router: Reverse Engineering TP-Link Archer AX1800 Firmware]]
  - runs binwalk & discusses the problems/traps
...
+ [[https://github.com/mirrexagon/nixpkgs-esp-dev][mirrexagon/nixpkgs-esp-dev]] can set up a devshell to build ESP software & read
  partition tables from binary blobs
