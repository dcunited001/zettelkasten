...
okay maybe a little more then that... it's hard for me to remember. I also don't
understand why i spend all my time programming, but i'm never pulled into
contributing to an open source project. IMO, it's because I especially need IRL
interactions in order to make broader connections and establish rapport.

I don't get that. At all. Zero. It's Roanoke. They don't understand the brain
drain. There's almost zero awareness of what's missing here.
#+end_quote
...
Contains information about [[https://github.com/openconfig/gnsi/blob/main/certz/certz.proto][CA rotation]]

*** Ansible

**** otobots via [[https://codeberg.org/sunshine-it/zerotrust/src/branch/main/collections/ansible_collections/otobots/bootbao/roles/requirements.yml][sunshine-it/zerotrust]]

Roles recommended by claude

+ [[https://codeberg.org/otobots/ansible-role-baocert.git][otobots.baocert]]
+ [[https://codeberg.org/otobots/ansible-role-openbao.git][otobots.openbao]]
+ [[https://codeberg.org/otobots/ansible-role-pin2tpm.git][otobots.pin2tpm]]
+ [[https://codeberg.org/otobots/ansible-role-pkcs11.git][otobots.pkcs11]]
+ [[https://codeberg.org/otobots/ansible-role-postgres_ssl.git][otobots.postgres_ssl]]

#+begin_src shell
# C-u M-|
curl -sq https://codeberg.org/sunshine-it/zerotrust/raw/branch/main/collections/ansible_collections/otobots/bootbao/roles/requirements.yml \
    | yq -r '.roles | map("+ [[\(.src)][\(.name)]]") | join("\n")'
#+end_src

Not bad. [[https://codeberg.org/sunshine-it/zerotrust/src/branch/main/docs/Architecture/Architecture.svg][Architecture.svg]] diagram that overviews the entire process

+ Some great [[https://codeberg.org/sunshine-it/zerotrust/src/branch/main/docs][docs]] which [[https://codeberg.org/sunshine-it/zerotrust/src/branch/main/docs/LLD-SEC-003.md#3-3-tpm-pcr-policy-and-pin-sealing][unseal secrets from TPM2]]. hard to come by.
+ Uses [[https://openbao.org/][OpenBAO]] a fork of vault. That's nice.
+ Shreads the tmpfile with temp luks keyslot. Doesn't shred/recreate the keyslot
  though. lol j/k (thanks AI). that's a VM disk.
+ In any case, you put it in terraform HCL. where's it running from? and how
  many VMs is it making?
+ Are they hardware TPM's -- no, probably not, but rackserver VM hosts probably
  be different. No one "steals" a VM, but the 10G networking implies that maybe
  they could "steal" the whole stack while it's running.
+ Doesn't describe how Tang gets the orange koolaid
+ i guess the disk is being served over some wild-ass RHEL devicemapper 10g
  multipath

Very interesting. Extremely helpful

[[file:img/talos/sunshine-it-zerotrust-architecture.svg]]
...

TBMuYN5AHEN5jtiBMkc3aKUt9Stwz847l28IkzuQytbXZJa9xup2kgyC
=zUxL
-----END PGP MESSAGE-----
