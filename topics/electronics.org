...
#+begin_quote
careful probing or you may fry fragile components in the power supply... like
the "one-wire memory" (wtf? transfer of EEPROM data over power)

For a PC, may result in reduced power profile or a [[https://electronics.stackexchange.com/questions/442503/what-is-the-polarity-of-this-barrel-plug-with-a-double-circle][refusal to charge battery]]
#+end_quote

+ [[https://electronics.stackexchange.com/questions/33968/how-to-tell-polarity-expected-of-a-dc-barrel-jack][How To Tell The Polarity of a DC Barrel Jack?]]
+ [[https://electronics.stackexchange.com/questions/442503/what-is-the-polarity-of-this-barrel-plug-with-a-double-circle][What Is The Polarity Of This Barrel Plug With A Double Circle?]] weird case
...
*** Solder & Solder Pin Oxididation Causes & Colors

[[https://mpe.researchmfg.com/soldering-pin-discoloration/][Soldering Pin Discolorization]] mentions this

| Color            | Oxide Depth (nm) |
|------------------+------------------|
...
Seeing some pinkish solder around heat-damaged parts. Causes could include

| Discolorization via flux migration | Migration of ions (Cu, maybe)       |
| Oxide buildup                      | Pin coating (Ni, Sb) or interaction |

There's also some pink fibrous strands on top of a few pins with the exact
pinkish color.
