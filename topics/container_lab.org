...
** SR Linux
+ [[https://documentation.nokia.com/sr/25-7/7750-sr/pdf/Multicast_Routing_Protocols_Guide_25.7.R1.pdf][Multicast Routing Protocols Guide 25.7.R1]]
...
Real-time network topology/protocols analyzer

+ [[https://skydive.network][skydive.network]] and [[https://github.com/skydive-project/skydive][skydive-project/skydive]]
