...
*** Eversions
+ sphere eversions
+ [[https://en.wikipedia.org/wiki/Minimax_eversion][minimax eversions]] these are "half-way models", saddle points for the wilmore
  energy (bending energy). This measures the deformation from a sphere.
  - [[https://arxiv.org/pdf/2511.18982][Willmore energy and curvature concentration]]
