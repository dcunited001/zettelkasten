...
** Docs
+ [[https://neovim.io/doc/user/#_api-%28extensibility%2fscripting%2fplugins%29][Neovim Docs: API (plugins)]]
...
**** Inter-Convert-arbor-realatifying...
+ [[https://github.com/smjonas/snippet-converter.nvim][smjonas/snippet-converter.nvim: Bundle snippets from multiple source...]]
  + and equivalent for emacs: [[https://github.com/MiniApollo/snippy][snippy.el]]
