...
** Resources
+ [[https://github.com/boringcollege/postgres-by-example/blob/main/lessons/psql-meta-commands.md][boringcollege/postgres-by-example ./lessons/psql-meta-commands.md]]
** Topics
