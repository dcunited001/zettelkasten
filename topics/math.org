...
Not necessarily "on a manifold", but uses ideas from Information Geometry and
Alg. Topology to learn a latent manifold representation.

See [[https://arxiv.org/abs/1802.03426][UMAP: Uniform Manifold Approximation/Projection for Dim. Reduction]] (2020)

+ Technique is comparable to t-SNE (dimensionality reduction)
+ [[https://elanapearl.github.io/blog/2021/umap/][Mapping Chemical Space with UMAP]]
