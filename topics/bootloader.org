...
[[https://documentation.suse.com/sles/16.0/html/SLES-PXE-server/index.html#sles-pxe-server-prepare-installer-dir-structure][Recommended Directory Structure (SUSE linux)]]:
