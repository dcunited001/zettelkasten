...
** OpenCypher (neo4j)
A query format that is supported by =guix graph=

+ [[https://opencypher.org/resources/][opencypher resources]] includes many "nice-to-haves" like EBNF, Antlr, etc.
...
+ demo [[https://arborist.metamodernmonkey.com/][arborist.metamodernmonkey.com]] and source [[https://github.com/aaronbeall/arborist-ui][aaronbeall/arborist-ui]]
+ simple app to view JSON, YAML and XML as trees or graphs.
