...
The cheatsheet from brendan gregg

[[file:img/linux/linux_perf_tools_full.png]]
...
Run =hardinfo2 -rf html > hardinfo.report.html= and wait a bit.
...
*** Examples
+ [[https://git.securityops.co/cristiancmoises/securityops-os/src/branch/main/SECURITY.md][hardened kernel for guix config]]
...
**** SystemD
+ [[https://www.freedesktop.org/software/systemd/man/latest/systemd.exec.html#SystemCallFilter=][man systemd.exec#SystemCallFilter=]]
...
+ [[https://blog.gitguardian.com/securing-containers-with-seccomp-part-1/][Securing Containers with Seccomp]]
...
See [[id:dae42c2e-aba7-4c9c-9878-b9665befe205][IPC And Sockets]]** Other Subsystems
...
+ caching and non-caching daemons for intercepting calls from glibc.so
+ useful in Nix and Guix to expand ABI compatibility and other functionality

Links

+ [[https://alternativebit.fr/posts/nixos/nsncd/nsncd-some-updates][NSNCD: Some Updates]]: progress after 
  a coding retreat
+ [[https://flokli.de/posts/2023-10-30-sockburp/][10/2023: Using sockburp to debug ns(n)cd]]
  - sockburp proxies traffic through unix socket-connected applications, showing pcaps for differing dataflows.
+ [[https://flokli.de/posts/2022-11-18-nsncd/][11/2022: NSNCD]]: start of blog series to debug nscd in Nix
  - hostname resolution issues involving NSS caching
...
*** Preventing program from dumping

Google says:

+ =/etc/security/limits.conf= or =/etc/profile.d/disable-coredumps.sh=
  - =* soft core 0= or =* hard core 0=
+ sudo sysctl -w fs.suid_dumpable=0 :: to disable setuid dumps (maybe probably a
  good idea)

but umm, i just stopped the service

*** Getting byte offset

Hmmm never conclusively answered this one

#+begin_example
Oct 12 03:39:44 kratos waybar[17107]: [2025-10-12 03:39:44.981] [error] [wireplumber]: Object '56' not found
Oct 12 03:39:44 kratos waybar[17107]: [2025-10-12 03:39:44.981] [error] Object '56' not found
Oct 12 03:40:44 kratos kernel: .waybar-wrapped[17117]: segfault at 60 ip 00007f22efb75d0d sp 00007f22e89fc238 error 4 in libc.so.6[175d0d,7f22efa28000+176000] likely on CPU 28 (core 12, socket 0)
Oct 12 03:40:44 kratos kernel: Code: 00 00 00 00 00 66 66 2e 0f 1f 84 00 00 00 00 00 66 66 2e 0f 1f 84 00 00 00 00 00 66 90 f3 0f 1e fa 48 89 f8 48 83 fa 20 72 23 <c5> fe 6f 06 48 83 fa 40 0f 87 a5 00 00 00 c5 fe 6f 4c 16 e0 c5 fe
Oct 12 03:40:44 kratos systemd-coredump[17182]: Process 17107 (.waybar-wrapped) of user 1000 terminated abnormally with signal 11/SEGV, processing...
#+end_example
...
#+begin_src shell
pid=$(pgrep -waybar | sort | head -n1)

# or --forest istead of -H
watch -n1 "ps -H -o pid,ppid,cmd p $pid" 
#+end_src
