...
+ [[https://github.com/Knosence9/project-vela][Knosence9/project-vela]]
  - [[https://github.com/Knosence9/project-vela/blob/main/tests/secretspec-integration.sh][tests/secretspec-integration.sh]]
+ [[https://github.com/Wawona/Wawona][wawona/wawona]] contains a lot
  - [[https://github.com/Wawona/Wawona/blob/94e744e67a9e16ec5190ee0eba68ff4dbb1f0a55/secretspec.toml][secretspec.toml]]
  - [[https://github.com/Wawona/Wawona/blob/94e744e67a9e16ec5190ee0eba68ff4dbb1f0a55/docs/maintainers/secrets.md][docs/maintainers/secrets.md]]
  - usage in GH actions, for signing/publishing to app store
+ [[https://github.com/frdminc/tendcf][frdminc/tendcf]] red team stuff
  - [[https://github.com/frdminc/tendcf/blob/393992becfe87527483dfb1cb10c86cf11147638/docs/architecture/architecture-DEFINITIVE-v3.md][architecture v3]] with [[https://github.com/frdminc/tendcf/tree/393992becfe87527483dfb1cb10c86cf11147638/schema][JSON schemata]] ... but doesn't seem to know to mark
    JSON/YAML as adhering to those schemas.  maybe it's intentional to prevent
    client apps from pulling it? idk
  - used fork [[https://github.com/frdminc/sudo-secretspec/blob/d513bdf32fafc06e8d6a7a09f910aff5d6705c88/docs/src/content/docs/providers/sqlite.md][sudo-secretspec which added an unencrypted sqlite provider]]
  - tons of useful information, generally, but probably more words than I could
    write in a lifetime (5,000,000+)
  - intended for CFEngine (distributed configuration management)
+ [[https://github.com/AIBEST-26-Team-Aphrodite/unit/blob/6bdc589c860a80181da3a20da5ba76dae271af50/secretspec.toml][AIBEST-26-Team-Aphrodite ./secretspec.toml]]
  - kafka, dragonfly, loki/grafana
+ [[https://github.com/scottylabs-labrador/labrador-recruit][scottylabs-labrador/labrador-recruit]]
+ [[https://github.com/ashebanow/nix-config][ashebanow/nix-config]]
  - [[https://github.com/ashebanow/nix-config/blob/32232d2664b48e02d602d7d80d382e62a16f2a02/secretspec.toml#L4][secretspec.toml]]
+ [[https://github.com/reverb256/nixos-config][reverb256/nixos-config]]
  - [[https://github.com/reverb256/nixos-config/blob/main/secretspec.toml][secretspec.toml]]
+ [[https://github.com/reverb256/Reverb-OS][reverb256/Reverb-OS]]
  - [[https://github.com/reverb256/Reverb-OS/blob/main/secretspec.toml][secretspec.toml]]

*** [[https://github.com/markus-barta/nixcfg][markus-barta/nixcfg]]

+ [[https://github.com/markus-barta/nixcfg/blob/main/secrets/NAMING-PATTERN.md][secrets/NAMING-PATTERN.md]] describes organization of secrets/naming
+ sophisticated usage patterns similar to what I have in mind.
+ [[https://github.com/markus-barta/nixcfg/blob/main/secrets/secrets.nix][manifest is here]] probably desperately wants secretspec.

#+begin_src shell
curl -qs https://raw.githubusercontent.com/markus-barta/nixcfg/refs/heads/main/flake.lock  \
  | tee \
    >(jq '.nodes | keys[] | select(match("_"))') \
    >(jq '.nodes | length') \
  | jq '[select(. | (strings)), select(. | (numbers))] | join("\n")'
# Confirmed AI token maxxer
#+end_src
...
+ [[https://github.com/betterleaks/betterleaks][betterleaks/betterleaks]]
+ [[https://github.com/gitleaks/gitleaks][gitleaks/gitleaks]]
