...
#+begin_src shell :tangle (file-expand-name "gpg-rekey.sh" ob@gnupg_useful_scripts_to_help_rekey_yubikey_and_rekey_secrets)
# shell :tangle (file-expand-name "gpg-rekey.sh" ob@gnupg_useful_scripts_to_help_rekey_yubikey_and_rekey_secrets)
...
#+begin_src shell #+begin_src shell :tangle (file-expand-name "gpg-rekey.sh" ob@gnupg_useful_scripts_to_help_rekey_yubikey_and_rekey_secrets)
...
_ykman_openpgp_backup() {
    ...
    echo cp -av gnupg.export/'$date'/'$KEYID'-Public.key \
