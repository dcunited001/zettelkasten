...
+ [[https://skatterbencher.com/2025/08/23/skatterbencher-89-orange-pi-5-max-overclocked-to-2650-mhz/][Orange Pi 5 Max overclocked to 2650 Mhz]] probably going to need a cooling
  solution though. lots of good information in here:
  - benchmarking a linux system
  - configuring CPU governors
  - customizing the _device tree_ (useful for building new devices & customizing
    driver support for U-Boot & kernel)
** Repos
...
** Cases
+ [[https://www.printables.com/search/models?q=tag%3Aorangepi5plus][Printables: #orangepi5plus]]
*** VESA

*** Tower
+ [[https://www.printables.com/model/646840-orange-pi-5-plus-case-with-40mm-x-10mm-fan][Orange Pi 5 Plus Case with 40mm x 10mm fan]]
+ [[https://www.printables.com/model/552094-orange-pi-5-plus-tower-case-version-2][Orange Pi 5 Plus Tower Case V2]]
  - with a few modifications, this would work well. fairly
    serviceable/modifiable: the only screws to assemble attach the board to the
    sides, but it still slides out. [[https://www.printables.com/model/523910-orange-pi-5-plus-open-case-v1][This]] one's good (same user), but it slides
    around a bit
  - has space to handle wifi antennae, but needs the right throughholes to
    attach them to
...
+ [[https://github.com/phaitonican/orangepi5b-flake][phaitonican/orangepi5b-flake]] this contains some clear instructions on how to
  build the [[https://github.com/rockchip-linux/rkbin][rockchip-linux/rkbin]] SPL loader
...
+ [[https://floss.social/@vagrantc/114154024787459911][floss.social thread]]
  + lykso/mnt-reform-nonguix #4 [[https://issues.guix.gnu.org/48266][Support dynamic loading of modules from initrd]]
    ...
    - see also [[https://codeberg.org/lykso/edk2-rk3588][lykso/edk2-rk3588]] for an edk2 build for rk3588
