...
** ykbootstrap ca
:PROPERTIES:
:header-args+: :var STEPPATH=".step.ykbootstrap" yk5root=12345678 ykpivpin=123456 ykpivpuk=12345678
:END:
...
#+begin_src yaml :tangle (expand-file-name ".sops.pre.yaml" step-root)
keys:
  users:
    # - &admin0    # gpg1 key
...
creation_rules:
  - path_regex: .step.ykbootstrap/[^/]sopsca.yaml$
    key_groups:
      - ykbookstrap:
          # - *admin0
          - *admin1
...
step ca init --key-password-file
#+end_src
