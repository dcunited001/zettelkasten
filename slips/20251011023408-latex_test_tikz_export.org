...
#+LATEX_HEADER_EXTRA: \usepackage{kinematikz}
...
... Well that was easy... get me a button.

+ In Doom Emacs, i'm using =texlive-scheme-full= for now, which installs um
  =texlive-collection-latexextra= I guess. It's massive
+ =texlive-kinematikz= is also included in =texlive-collection-pictures=
...
[[file:img/frc/kinematikz-test.png]]
