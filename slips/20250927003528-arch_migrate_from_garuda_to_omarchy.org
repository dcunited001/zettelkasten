...
I ended up running =make= on the =nixos= machine
...
#+begin_src shell
make install # will setup guix-daemon.{service,socket}

# see https://guix.gnu.org/manual/devel/en/guix.html#Build-Environment-Setup
