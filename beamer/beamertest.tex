...
\label{sec:org782eb96}

\begin{frame}[label={sec:org7615b18}]{Frame 1}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8d253c7}]{Frame 2 (where we will not use columns)}
\begin{block}{Request}
