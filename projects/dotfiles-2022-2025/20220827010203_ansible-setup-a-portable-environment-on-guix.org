...
The most recent version of this is probably in my dotfiles +as [[https://github.com/dcunited001/ellipsis/tree/master/ANSIBLE.org][ANSIBLE.org]]+ is
here. It generates a project, still not sure whether I want it there or not. I'd
rather use =guix deploy=
