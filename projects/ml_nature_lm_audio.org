...
+ [[https://github.com/ictnlp/LLaMA-Omni][ictnlp/LLaMA-Omni]] uses [[https://github.com/jik876/hifi-gan][jik876/hifi-gan]] but this won't work because Cisco =G.711=
  and =G.729= QED...
  - neural nets vocoders would be different, but similar in purpose and function
  - it's difficult to synthesize the human voice without artifacts (i think,
    definitely for digital)

Other Resources

+ [[https://arxiv.org/abs/2508.09126v1][Neutone SDK: Open Source Framework for Neural Audio Processing]]
+ [[https://arxiv.org/abs/2406.00146][A survey of deep learning audio generation methods]]
...
#+begin_src plantuml :file "img/nature-lm-inference.png"  :noweb yes
@startyaml
...
#+RESULTS:
[[file:img/nature-lm-inference.png]]

*** Train Stage 1

#+begin_src plantuml :file "img/nature-lm-train_stage1.png"  :noweb yes
@startyaml
...
#+RESULTS:
[[file:img/nature-lm-train_stage1.png]]
