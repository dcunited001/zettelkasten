...
#+name: ffBookmarks
#+call: ffSchemaDiagram(ffdb="bookmarks.sqlite") :exports both
...
#+name: ffContentPrefs
#+call: ffSchemaDiagram(ffdb="content-prefs.sqlite") :exports both
...
#+name: ffCookies
#+call: ffSchemaDiagram(ffdb="cookies.sqlite") :exports both
