...
#+name: ffBookmarks
#+call: ffSchemaDiagram(ffdb="bookmarks.sqlite") :results file link :exports both
...
#+name: ffContentPrefs
#+call: ffSchemaDiagram(ffdb="content-prefs.sqlite") :results file link :exports both
...
#+name: ffCookies
#+call: ffSchemaDiagram(ffdb="cookies.sqlite") :results file link :exports both
