:PROPERTIES:
:ID:       b6d2c374-bdd0-4034-9867-c44af23c5d9a
:END:
#+TITLE: Riastradh's Lisp Style Rules
#+DESCRIPTION: Apple
#+TAGS:
#+AUTHOR:    Riastradh
...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="riastradh-scheme-style-guide.css" />
...
See =M-x org-html-htmlize-generate-css=. Set =org-html-htmlize-output-type= to =css=

#+begin_src css :tangle "./riastradh-scheme-style-guide.css"
/* org reset --------------------------------------------- */
...
pre {  border: none; padding: 0.2em; margin: auto 0.5em;; background-color: #F9F6F9;  }
...
/* p.verse b { color: darkgreen; } */
p.verse { font-family: monospace; padding: 0; margin: 0.2em}; }
#+end_src
