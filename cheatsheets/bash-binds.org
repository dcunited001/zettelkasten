...
#+begin_quote
Avoid RSI: ensure your keyboard has _symmetric modkeys_ for *ambidextrous usage* and
/to disrupt muscle memory/. Do not use the control in the lower corners. =τ = (r×F)=
#+end_quote
