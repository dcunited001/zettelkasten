...
\cvexp{2022-2023}{Engineering Student Aide}{(fdsa)}{Virginia Western}
...
\cvexp{2018}{Cloud Engineer}{()}{RAKE Digital}
...
%
\cvexp{2015-2017}{Founder}{()}{Voxxel}
...
\cvexp{2011-2015}{Founder}{()}{Oscil8}
...
%
\cvexp{2014}{Software Developer}{(Contract, Remote)}{Left+Right}
...
%
\cvexp{2013}{Software Engineer \scriptsize{\textbf{(Boulder, CO)}}}{Jumpcloud}
...
%
\cvexp{2012-2013}{Software Engineer \scriptsize{\textbf{(Denver, CO)}}}{Weedmaps}
{\cvpoint{}} % \\[\spread]
%
\cvexp{2011-2012}{Owner, Developer \scriptsize{\textbf{(Contract, Remote)}}}{Sic Semper LLC}
{\cvpoint{}} % \\[\spread]
%
\cvexp{2012}{Ruby Developer \scriptsize{\textbf{(Albany, NY)}}}{Internet Marketing Ninjas}
{\cvpoint{}} % \\[\spread]
%
\cvexp{2011}{Database Developer \scriptsize{\textbf{(Virginia Beach VA)}}}{ABS}{}
\cvexp{2010-2011}{C# Developer \scriptsize{\textbf{(Christiansburg, VA)}}}{CCS}
{\cvpoint{}} % \\[\spread]
%
\cvexp{2010-2011}{Network Associate \scriptsize{\textbf{(Roanoke, VA)}}}{ABS}

%
% \cvsection{Tools}
% \metasection{Lang}{Ruby, Python, Java, JS, TS, Clojure, Emacs Lisp, Scheme, Julia, Swift}
% \metasection{Tools}{Bash, Ansible, SSH Tunnels, Emacs}
% \metasection{HW}{Robotics, VTY Console, GNU Screen}
% \metasection{Data}{Reporting, ETL, jq, Postgres, MSSQL, SQLite3, Parquet}
% \cvrule{-6pt}{0pt}
#+end_export
