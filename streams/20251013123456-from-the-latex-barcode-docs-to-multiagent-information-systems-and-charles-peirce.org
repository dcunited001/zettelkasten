...
incomplete... I somewhat remember writing this outline. way too full of tangents

* Outline

+ [[https://ctan.mirrors.hoobly.com/graphics/pstricks/contrib/pst-barcode/doc/pst-barcode-doc.pdf][PSTricks: a package for drawing barcodes: v0.19]]

** Intro
*** Appetite For Complexity
Presented with the CTAN barcode library for LaTeX, where does one extrapolate?
...
A similar example which needs inductive thinking and a tendancy to challenge
facts: "Were Romans or other Iron Age cultures aware that lead was toxic?"

#+begin_quote
Yes. At least it is impossible that some Romans were almost certain in knowing
that. It is impossible for some humans that encounter sources of lead & silver
to not know this, though they wouldn't know the severity, the details/vectors by
which toxicity is induced or precisely how it affected people.

*Novelty:* You can't mine/smelt the more common form of silver without handling
large amounts of lead. There is variance in exposure between different roles for
handling the resources:

+ mining: powdered galena
+ smelting: lead fumes
+ being _anywhere near where galena has been smelted_ at some time

There's enough variance in the exposure to infer people would draw subjective
insights about occupational exposure. probably not quite an idea of a "mad
hatter" related to lead exposure. As there are the economic & security aspects,
it's likely no one wrote it down, though separating the lead from silver effects
the development of alchemical though. It's not good for the economy to talk
about why all those people engaged in silver mining/smelting are violent raving
psychopaths (chronic lead poisoing) who die of complications from chronic+acute
lead poisoning (like weak kidneys).
#+end_quote

[[https://www.reddit.com/r/geology/comments/6inknf/is_galena_a_health_risk/][Is Galena A Health Risk?]]
